...
public class SwaggerConfig {
    public static final Contact DEFAULT_CONTACT = new Contact("Alex", "http://wwww.in28minutes.com", "melikhov914@gmail.com");
    private static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Api Title for ALEX service",
